...
(function( $ ) {
  ...
  var word_arrays = [
      {text: "domestic violence", weight: 20},
      {text: "poverty", weight: 10.5 },
    
      {text: "cdomestic violence", weight: 8},
      {text: "voter suppression", weight: 7.5},
      {text: "pollution", weight: 40, html: {class: "category card"}},
      {text: "homelessness", weight: 6.8, html: {class: "category card"}},
      {text: "bullying", weight: 6.1, html: {class: "category card"}},
      {text: "child abuse", weight: 15, html: {class: "category card"}},
      {text: "bullying", weight: 3, html: {class: "category card"}},
     
      {text: "social injustice", weight: 30, html: {class: "category fees"}},
      {text: "neglected children", weight:9, html: {class: "category fees"}},
